...
def load_abide_data(cfg: DictConfig):
    ...
    with open_dict(cfg):
        ...
        print(cfg.dataset.node_sz, "cfg.dataset.node_sz")
        print(cfg.dataset.node_feature_sz, "cfg.dataset.node_feature_sz")
        print(cfg.dataset.timeseries_sz, "cfg.dataset.timeseries_sz")
